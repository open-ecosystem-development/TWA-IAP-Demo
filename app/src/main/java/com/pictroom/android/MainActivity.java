...
public class MainActivity extends Activity {
    ...
    /**
     * Signals if {@link MainActivity} should automatically launch the Trusted Web Activity on
    ...
    protected void launchTwa() {
        ...
        //Assume that lack of GMS means app is loaded on Huawei device.
    ...
    /**
     * Checks if Google Mobile Services is available on device.
     */
