...
import com.ychen9.pwa.adapter.ProductListAdapter;
...
//                Intent intent = new Intent(com.ychen9.pwa.ConsumptionActivity.this, PurchaseHistoryActivity.class);
...
//        });
    ...
    private void queryProducts() {
        ...
        IapRequestHelper.obtainProductInfo(mClient, productIds, IapClient.PriceType.IN_APP_CONSUMABLE, new IapApiCallback<ProductInfoResult>() {
            ...
            public void onFail(Exception e) {
                ...
                ExceptionHandle.handle(com.ychen9.pwa.ConsumptionActivity.this, e);
                showProducts();
            }
        });
    }
    ...
    private void showProducts() {
        ...
        adapter = new ProductListAdapter(com.ychen9.pwa.ConsumptionActivity.this, consumableProducts);
    ...
    private void deliverProduct(final String inAppPurchaseDataStr, final String inAppPurchaseDataSignature) {
        ...
        if (CipherUtil.doCheck(inAppPurchaseDataStr, inAppPurchaseDataSignature, CipherUtil.getPublicKey())) {
            try {
                ...
                if (DeliveryUtils.isDelivered(com.ychen9.pwa.ConsumptionActivity.this, purchaseToken)) {
    ...
    private void updateNumberOfGems() {
        ...
        String countOfGems = String.valueOf(DeliveryUtils.getCountOfGems(com.ychen9.pwa.ConsumptionActivity.this));
    ...
    private void buy(int index) {
        ...
        IapRequestHelper.createPurchaseIntent(mClient, productInfo.getProductId(), IapClient.PriceType.IN_APP_CONSUMABLE, new IapApiCallback<PurchaseIntentResult>() {
            ...
            public void onSuccess(PurchaseIntentResult result) {
                ...
                IapRequestHelper.startResolutionForResult(com.ychen9.pwa.ConsumptionActivity.this, status, Constants.REQ_CODE_BUY);
            }

            @Override
            public void onFail(Exception e) {
                int errorCode = ExceptionHandle.handle(com.ychen9.pwa.ConsumptionActivity.this, e);
